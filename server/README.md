...
Backend RESTful API cho hệ thống quản lý phòng trọ, xây dựng với NestJS, SQL Server, và Prisma.
...
- Node.js 18+ 
- SQL Server 2019+ hoặc Docker image SQL Server 2022
- npm hoặc yarn
...
# Chạy script SQL Server đã gộp
# Mở server/sql/init.sql và chạy trong database phongtro_db
...
```bash
DATABASE_URL="sqlserver://localhost:1433;database=phongtro_db;user=sa;password=YourStrong@Passw0rd;trustServerCertificate=true;encrypt=true"
```
