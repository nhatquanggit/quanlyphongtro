...
const Sidebar: React.FC<SidebarProps> = ({ activePage, onNavigate, lang, onLogout, mobileOpen = false, onCloseMobile }) => {
  ...
  return (
    <aside className={`sidebar ${mobileOpen ? 'sidebar--mobile-open' : ''}`}>
      ...
      <div className="sidebar__bottom">
        <div className={`sidebar__settings ${activePage === 'settings' ? 'active' : ''}`} onClick={() => {
          onNavigate('settings');
          onCloseMobile?.();
        }}>
        ...
        <div className="sidebar__logout" onClick={() => {
          onLogout();
          onCloseMobile?.();
        }}>
